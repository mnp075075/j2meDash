...
// this is specifically compiled for java 8 instead of java 1.4
// i have no reason why you would want this
// just in case

// THIS VERSION MAY OR MAY NOT BE MAINTAINED OR UPDATED LIKE THE ONE COMPILED WITH 1.4
// SO IT COULD BE OUTDATED AND SUCH
...
public class GDOnJavaForJava8 extends MIDlet implements CommandListener { 
	...
	*/
	...
	class SoundForm extends Form {
		...
		public SoundForm() {
			...
			setCommandListener(GDOnJavaForJava8.this);
