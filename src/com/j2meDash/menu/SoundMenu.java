...
public class SoundMenu extends GameCanvas {
	...
	public void paint(Graphics g) {
		...
		g.drawString("Do you want to have sound?", 120, 30, Graphics.BASELINE | Graphics.HCENTER);
		g.drawString("FUN FACT:", 120, 60, Graphics.BASELINE | Graphics.HCENTER);
		...
		g.drawString("So do you want sound?", 120, 285, Graphics.BASELINE | Graphics.HCENTER);
		g.setColor(0,206,119);
		g.fillRect(40, 310, 40, 20);
		g.fillRect(160, 310, 40, 20);
		g.setColor(255,255,255);
		g.drawString("Yes", 60, 320, Graphics.BASELINE | Graphics.HCENTER);
		g.drawString("No", 180, 320, Graphics.BASELINE | Graphics.HCENTER);
